        ...
        <div className="d-block d-md-flex podcast-entry bg-white mb-5">
            <div className="image" style={{backgroundImage: "url('images/img_1.jpg')"}}></div>
                <div className="text">
                    ...
                    <div className="text-white mb-3"><span className="text-black-opacity-05"><small>By John Doe <span className="sep">/</span> 16 September 2017 <span className="sep">/</span> 1:30:20</small></span></div>
